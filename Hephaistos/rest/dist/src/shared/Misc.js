...
exports.getEmail = exports.userMW = exports.adminMW = exports.getRandomInt = exports.pErr = exports.pwdSaltRounds = exports.loginFailedErr = exports.paramMissingError = void 0;
...
exports.userMW = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const clientData = yield jwtService.decodeJwt(jwt);
        if (clientData.role === User_1.UserRoles.Standard || clientData.role === User_1.UserRoles.Admin) {
            next();
        }
        else {
            throw Error('JWT not present in signed cookie.');
